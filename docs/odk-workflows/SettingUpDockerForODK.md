...
`robot_java_args: '-Xmx8G'` to your src/ontology/artificial-intelligence-ontology-odk.yaml file, see for example [here](https://github.com/INCATools/ontology-development-kit/blob/0e0aef2b26b8db05f5e78b7c38f807d04312d06a/configs/uberon-odk.yaml#L36).
