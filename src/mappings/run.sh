...
runoak -i sqlite:obo:ito -a sqlite:obo:aio lexmatch i^ito @ i^aio -o aio-to-ito.sssom_full.tsv
runoak -i sqlite:obo:edam -a sqlite:obo:aio lexmatch i^edam @ i^aio -o aio-to-edam.sssom_full.tsv
runoak -i sqlite:obo:obiws -a sqlite:obo:aio lexmatch i^obiws @ i^aio -o aio-to-obiws.sssom_full.tsv
